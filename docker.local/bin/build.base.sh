...
echo ""
echo "3> docker build"
DOCKER_BUILDKIT=1 docker buildx build --platform linux/arm64 --progress=plain --build-arg GIT_COMMIT=$GIT_COMMIT --buildkitd-flags '--allow-insecure-entitlement network.host' -f docker.local/base.Dockerfile . -t $DOCKER_IMAGE_BASE
