...
type Ref struct {
	...
	Children            []*Ref         `gorm:"-" json:"children,omitempty"`
	childrenLoaded      bool

	OnCloud        bool            `gorm:"column:on_cloud" filelist:"on_cloud" json:"on_cloud,omitempty"`
	CommitMetaTxns []CommitMetaTxn `gorm:"foreignkey:ref_id" filelist:"commit_meta_txns" json:"commit_meta_txns,omitempty"`
	...
	DeletedAt gorm.DeletedAt `gorm:"column:deleted_at" json:"deleted_at,omitempty"` // soft deletion

	ChunkSize int64 `gorm:"column:chunk_size" dirlist:"chunk_size" filelist:"chunk_size" json:"chunk_size"`
}
