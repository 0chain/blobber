...
type Ref struct {
	...
	Type                string         `gorm:"column:type" dirlist:"type" filelist:"type" json:"type"`
	AllocationID        string         `gorm:"column:allocation_id" json:"allocation_id"`
	LookupHash          string         `gorm:"column:lookup_hash" dirlist:"lookup_hash" filelist:"lookup_hash" json:"lookup_hash"`
	Name                string         `gorm:"column:name" dirlist:"name" filelist:"name" json:"name"`
	Path                string         `gorm:"column:path" dirlist:"path" filelist:"path" json:"path"`
	Hash                string         `gorm:"column:hash" dirlist:"hash" filelist:"hash" json:"hash"`
	NumBlocks           int64          `gorm:"column:num_of_blocks" dirlist:"num_of_blocks" filelist:"num_of_blocks" json:"num_blocks"`
	PathHash            string         `gorm:"column:path_hash" dirlist:"path_hash" filelist:"path_hash" json:"path_hash"`
	ParentPath          string         `gorm:"column:parent_path" json:"parent_path"`
	PathLevel           int            `gorm:"column:level" json:"level"`
	CustomMeta          string         `gorm:"column:custom_meta" filelist:"custom_meta" json:"custom_meta"`
	ContentHash         string         `gorm:"column:content_hash" filelist:"content_hash" json:"content_hash"`
	Size                int64          `gorm:"column:size" dirlist:"size" filelist:"size" json:"size"`
	MerkleRoot          string         `gorm:"column:merkle_root" filelist:"merkle_root" json:"merkle_root"`
	ActualFileSize      int64          `gorm:"column:actual_file_size" filelist:"actual_file_size" json:"actual_file_size"`
	ActualFileHash      string         `gorm:"column:actual_file_hash" filelist:"actual_file_hash" json:"actual_file_hash"`
	MimeType            string         `gorm:"column:mimetype" filelist:"mimetype" json:"mimetype"`
	WriteMarker         string         `gorm:"column:write_marker" json:"write_marker"`
	ThumbnailSize       int64          `gorm:"column:thumbnail_size" filelist:"thumbnail_size" json:"thumbnail_size"`
	ThumbnailHash       string         `gorm:"column:thumbnail_hash" filelist:"thumbnail_hash" json:"thumbnail_hash"`
	ActualThumbnailSize int64          `gorm:"column:actual_thumbnail_size" filelist:"actual_thumbnail_size" json:"actual_thumbnail_size"`
	ActualThumbnailHash string         `gorm:"column:actual_thumbnail_hash" filelist:"actual_thumbnail_hash" json:"actual_thumbnail_hash"`
	EncryptedKey        string         `gorm:"column:encrypted_key" filelist:"encrypted_key" json:"encrypted_key"`
	Attributes          datatypes.JSON `gorm:"column:attributes" filelist:"attributes" json:"attributes"`
	Children            []*Ref         `gorm:"-"`
	childrenLoaded      bool
	...
	CreatedAt      time.Time       `gorm:"column:created_at" dirlist:"created_at" filelist:"created_at" json:"created_at"`
	UpdatedAt      time.Time       `gorm:"column:updated_at" dirlist:"updated_at" filelist:"updated_at" json:"updated_at"`
