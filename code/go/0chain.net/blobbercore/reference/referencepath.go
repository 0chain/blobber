...
func GetReferenceForHashCalculationFromPaths(ctx context.Context, allocationID string, paths []string) (*Ref, error) {
	...
	db = db.Model(&Ref{}).Select("id", "file_id", "type", "allocation_id", "lookup_hash", "name", "path",
		"hash", "path_hash", "parent_path", "size", "file_meta_hash", "validation_root", "fixed_merkle_root",
		"actual_file_size", "actual_file_hash", "chunk_size",
		"thumbnail_hash", "allocation_root", "level", "created_at", "updated_at")
