...
func setupCopyHandler() (*mux.Router, map[string]string) {
...
func TestHandlers_Copy(t *testing.T) {
	setup(t)
	...
	router, handlers := setupCopyHandler()
	...
	for _, name := range handlers {
		...
		emptySignature := test{
			...
			wantBody:    "{\"error\":\"bad request: invalid signature \"}\n\n",
		}
		...
		wrongSignature := test{
			...
			setupDbMock: baseSetupDbMock,
			wantCode:    http.StatusBadRequest,
			wantBody:    "{\"error\":\"bad request: invalid signature e1835825961d77afdf55fd5bc8b60729ed467e959b4427c8dee87416580ffc98\"}\n\n",
		}
