...
var file_blobber_proto_rawDesc = []byte{
	...
	0x6c, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xc6, 0x01, 0x0a, 0x16, 0x47, 0x65,
	...
	0x6f, 0x6e, 0x22, 0x19, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x46, 0x69, 0x6c, 0x65, 0x4d, 0x65, 0x74,
	0x61, 0x44, 0x61, 0x74, 0x61, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xb6, 0x04,
	...
	0x92, 0x02, 0x0a, 0x07, 0x42, 0x6c, 0x6f, 0x62, 0x62, 0x65, 0x72, 0x12, 0x79, 0x0a, 0x0d, 0x47,
	...
	0x65, 0x22, 0x13, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x0d, 0x12, 0x0b, 0x2f, 0x61, 0x6c, 0x6c, 0x6f,
	0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x8b, 0x01, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x46, 0x69,
	...
	0x6e, 0x73, 0x65, 0x22, 0x1f, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x19, 0x12, 0x17, 0x2f, 0x66, 0x69,
	0x6c, 0x65, 0x2f, 0x6d, 0x65, 0x74, 0x61, 0x2f, 0x7b, 0x61, 0x6c, 0x6c, 0x6f, 0x63, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x7d, 0x42, 0x0f, 0x5a, 0x0d, 0x2e, 0x2f, 0x62, 0x6c, 0x6f, 0x62, 0x62, 0x65,
...
var file_blobber_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_blobber_proto_goTypes = []interface{}{
	...
	(*GetFileMetaDataResponse)(nil), // 4: blobber.service.v1.GetFileMetaDataResponse
	(*Allocation)(nil),              // 5: blobber.service.v1.Allocation
	(*Term)(nil),                    // 6: blobber.service.v1.Term
}
var file_blobber_proto_depIdxs = []int32{
	...
	5, // 1: blobber.service.v1.GetAllocationResponse.allocation:type_name -> blobber.service.v1.Allocation
	0, // 2: blobber.service.v1.GetFileMetaDataRequest.context:type_name -> blobber.service.v1.RequestContext
	6, // 3: blobber.service.v1.Allocation.Terms:type_name -> blobber.service.v1.Term
	1, // 4: blobber.service.v1.Blobber.GetAllocation:input_type -> blobber.service.v1.GetAllocationRequest
	3, // 5: blobber.service.v1.Blobber.GetFileMetaData:input_type -> blobber.service.v1.GetFileMetaDataRequest
	2, // 6: blobber.service.v1.Blobber.GetAllocation:output_type -> blobber.service.v1.GetAllocationResponse
	4, // 7: blobber.service.v1.Blobber.GetFileMetaData:output_type -> blobber.service.v1.GetFileMetaDataResponse
