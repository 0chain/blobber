...
type ListEntitiesResponse struct {
	...
	DirMetaData    *DirMetaData    `protobuf:"bytes,2,opt,name=DirMetaData,proto3" json:"DirMetaData,omitempty"`
	FileEntities   []*FileMetaData `protobuf:"bytes,3,rep,name=FileEntities,proto3" json:"FileEntities,omitempty"`
	DirEntities    []*DirMetaData  `protobuf:"bytes,4,rep,name=DirEntities,proto3" json:"DirEntities,omitempty"`
}
...
func (x *ListEntitiesResponse) GetDirMetaData() *DirMetaData {
	if x != nil {
...
func (x *ListEntitiesResponse) GetFileEntities() []*FileMetaData {
	if x != nil {
		return x.FileEntities
	}
	return nil
}

func (x *ListEntitiesResponse) GetDirEntities() []*DirMetaData {
	if x != nil {
		return x.DirEntities
	}
	return nil
}
...
var file_blobber_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0xc3, 0x01, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x69,
	0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x3c, 0x0a, 0x07, 0x63, 0x6f, 0x6e,
	...
	0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x8a, 0x02, 0x0a, 0x14, 0x4c, 0x69, 0x73, 0x74,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x52, 0x6f, 0x6f, 0x74, 0x12, 0x41, 0x0a, 0x0b, 0x44, 0x69, 0x72, 0x4d,
	0x65, 0x74, 0x61, 0x44, 0x61, 0x74, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e,
	...
	0x44, 0x69, 0x72, 0x4d, 0x65, 0x74, 0x61, 0x44, 0x61, 0x74, 0x61, 0x12, 0x44, 0x0a, 0x0c, 0x46,
	0x69, 0x6c, 0x65, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x69, 0x65, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28,
	...
	0x61, 0x74, 0x61, 0x52, 0x0c, 0x46, 0x69, 0x6c, 0x65, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x69, 0x65,
	0x73, 0x12, 0x41, 0x0a, 0x0b, 0x44, 0x69, 0x72, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x69, 0x65, 0x73,
	0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x62, 0x6c, 0x6f, 0x62, 0x62, 0x65, 0x72,
	0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x44, 0x69, 0x72, 0x4d,
	0x65, 0x74, 0x61, 0x44, 0x61, 0x74, 0x61, 0x52, 0x0b, 0x44, 0x69, 0x72, 0x45, 0x6e, 0x74, 0x69,
	0x74, 0x69, 0x65, 0x73, 0x22, 0x87, 0x02, 0x0a, 0x0b, 0x44, 0x69, 0x72, 0x4d, 0x65, 0x74, 0x61,
	...
	0x01, 0x28, 0x03, 0x52, 0x09, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0xa4,
	0x01, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x46, 0x69, 0x6c, 0x65, 0x53, 0x74, 0x61, 0x74, 0x73, 0x52,
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x89, 0x01, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x46, 0x69, 0x6c,
	0x65, 0x53, 0x74, 0x61, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3c,
	...
	0x74, 0x61, 0x52, 0x08, 0x4d, 0x65, 0x74, 0x61, 0x44, 0x61, 0x74, 0x61, 0x12, 0x33, 0x0a, 0x05,
	...
	0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0xc6, 0x01, 0x0a, 0x16, 0x47, 0x65,
	...
	0x6f, 0x6e, 0x22, 0xaf, 0x06, 0x0a, 0x0c, 0x46, 0x69, 0x6c, 0x65, 0x4d, 0x65, 0x74, 0x61, 0x44,
	...
	0x65, 0x64, 0x41, 0x74, 0x22, 0x9f, 0x01, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x46, 0x69, 0x6c, 0x65,
	0x4d, 0x65, 0x74, 0x61, 0x44, 0x61, 0x74, 0x61, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x12, 0x3c, 0x0a, 0x08, 0x4d, 0x65, 0x74, 0x61, 0x44, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x01,
	...
	0x44, 0x61, 0x74, 0x61, 0x52, 0x08, 0x4d, 0x65, 0x74, 0x61, 0x44, 0x61, 0x74, 0x61, 0x12, 0x46,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x41,
	0x74, 0x22, 0x67, 0x0a, 0x0e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x43, 0x6f, 0x6e, 0x74,
	...
	0x0a, 0x57, 0x72, 0x69, 0x74, 0x65, 0x50, 0x72, 0x69, 0x63, 0x65, 0x32, 0xa9, 0x04, 0x0a, 0x07,
...
var file_blobber_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_blobber_proto_goTypes = []interface{}{
	(*ListEntitiesRequest)(nil),     // 0: blobber.service.v1.ListEntitiesRequest
	(*ListEntitiesResponse)(nil),    // 1: blobber.service.v1.ListEntitiesResponse
	(*DirMetaData)(nil),             // 2: blobber.service.v1.DirMetaData
	(*GetFileStatsRequest)(nil),     // 3: blobber.service.v1.GetFileStatsRequest
	(*GetFileStatsResponse)(nil),    // 4: blobber.service.v1.GetFileStatsResponse
	(*FileStats)(nil),               // 5: blobber.service.v1.FileStats
	(*GetFileMetaDataRequest)(nil),  // 6: blobber.service.v1.GetFileMetaDataRequest
	(*FileMetaData)(nil),            // 7: blobber.service.v1.FileMetaData
	(*GetFileMetaDataResponse)(nil), // 8: blobber.service.v1.GetFileMetaDataResponse
	(*CommitMetaTxn)(nil),           // 9: blobber.service.v1.CommitMetaTxn
	(*Collaborator)(nil),            // 10: blobber.service.v1.Collaborator
	(*RequestContext)(nil),          // 11: blobber.service.v1.RequestContext
	...
	(*Allocation)(nil),              // 14: blobber.service.v1.Allocation
	(*Term)(nil),                    // 15: blobber.service.v1.Term
}
var file_blobber_proto_depIdxs = []int32{
	11, // 0: blobber.service.v1.ListEntitiesRequest.context:type_name -> blobber.service.v1.RequestContext
	2,  // 1: blobber.service.v1.ListEntitiesResponse.DirMetaData:type_name -> blobber.service.v1.DirMetaData
	7,  // 2: blobber.service.v1.ListEntitiesResponse.FileEntities:type_name -> blobber.service.v1.FileMetaData
	2,  // 3: blobber.service.v1.ListEntitiesResponse.DirEntities:type_name -> blobber.service.v1.DirMetaData
	11, // 4: blobber.service.v1.GetFileStatsRequest.context:type_name -> blobber.service.v1.RequestContext
	7,  // 5: blobber.service.v1.GetFileStatsResponse.MetaData:type_name -> blobber.service.v1.FileMetaData
	5,  // 6: blobber.service.v1.GetFileStatsResponse.Stats:type_name -> blobber.service.v1.FileStats
	11, // 7: blobber.service.v1.GetFileMetaDataRequest.context:type_name -> blobber.service.v1.RequestContext
	9,  // 8: blobber.service.v1.FileMetaData.CommitMetaTxns:type_name -> blobber.service.v1.CommitMetaTxn
	7,  // 9: blobber.service.v1.GetFileMetaDataResponse.MetaData:type_name -> blobber.service.v1.FileMetaData
	10, // 10: blobber.service.v1.GetFileMetaDataResponse.Collaborators:type_name -> blobber.service.v1.Collaborator
	11, // 11: blobber.service.v1.GetAllocationRequest.context:type_name -> blobber.service.v1.RequestContext
	14, // 12: blobber.service.v1.GetAllocationResponse.allocation:type_name -> blobber.service.v1.Allocation
	15, // 13: blobber.service.v1.Allocation.Terms:type_name -> blobber.service.v1.Term
	12, // 14: blobber.service.v1.Blobber.GetAllocation:input_type -> blobber.service.v1.GetAllocationRequest
	6,  // 15: blobber.service.v1.Blobber.GetFileMetaData:input_type -> blobber.service.v1.GetFileMetaDataRequest
	3,  // 16: blobber.service.v1.Blobber.GetFileStats:input_type -> blobber.service.v1.GetFileStatsRequest
	0,  // 17: blobber.service.v1.Blobber.ListEntities:input_type -> blobber.service.v1.ListEntitiesRequest
	13, // 18: blobber.service.v1.Blobber.GetAllocation:output_type -> blobber.service.v1.GetAllocationResponse
	8,  // 19: blobber.service.v1.Blobber.GetFileMetaData:output_type -> blobber.service.v1.GetFileMetaDataResponse
	4,  // 20: blobber.service.v1.Blobber.GetFileStats:output_type -> blobber.service.v1.GetFileStatsResponse
	1,  // 21: blobber.service.v1.Blobber.ListEntities:output_type -> blobber.service.v1.ListEntitiesResponse
