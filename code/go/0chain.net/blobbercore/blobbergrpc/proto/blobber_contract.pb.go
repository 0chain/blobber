...
type MarketplaceShareInfoResponse struct {
	...
	ResponseStatus int64  `protobuf:"varint,1,opt,name=response_status,json=responseStatus,proto3" json:"response_status,omitempty"`
...
func (x *MarketplaceShareInfoResponse) GetResponseStatus() int64 {
	if x != nil {
...
var file_blobber_contract_proto_rawDesc = []byte{
	...
	0x6e, 0x73, 0x65, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03,
