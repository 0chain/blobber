...
func (fs *MockStore) GetBlocksMerkleTreeForChallenge(cid string, allocID string,
	fileData *FileInputData, blockoffset int) (json.RawMessage, util.MerkleTreeI, error) {

	return fs.FileStore.GetBlocksMerkleTreeForChallenge(cid, allocID, fileData, blockoffset)
}
