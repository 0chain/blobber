...
func (_m *PackageHandler) GetLatestReadMarkerEntity(ctx context.Context, clientID string) (readmarker.ReadMakerI, error) {
	ret := _m.Called(ctx, clientID)

	var r0 readmarker.ReadMakerI
	if rf, ok := ret.Get(0).(func(context.Context, string) readmarker.ReadMakerI); ok {
		r0 = rf(ctx, clientID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(readmarker.ReadMakerI)
		}
	}
...
// GetNewReadMaker provides a mock function with given fields: rm
func (_m *PackageHandler) GetNewReadMaker(rm *readmarker.ReadMarker) readmarker.ReadMakerI {
	ret := _m.Called(rm)

	var r0 readmarker.ReadMakerI
	if rf, ok := ret.Get(0).(func(*readmarker.ReadMarker) readmarker.ReadMakerI); ok {
		r0 = rf(rm)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(readmarker.ReadMakerI)
