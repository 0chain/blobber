...
CREATE INDEX idx_is_precommit_deleted_at on reference_objects(allocation_id,allocation_version) INCLUDE(lookup_hash,id) WHERE type='f' AND deleted_at IS NULL;
