...
CREATE INDEX idx_is_precommit_deleted_at on reference_objects(allocation_id) INCLUDE(type,lookup_hash,id) WHERE is_precommit=true AND deleted_at IS NULL;
